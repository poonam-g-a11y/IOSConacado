...
import { View, Text, ImageBackground, TouchableOpacity, StyleSheet,Dimensions, Modal, ScrollView, TextInput, KeyboardAvoidingView, } from 'react-native'
            ...
            <View style={styles.container}>
                ...
                <View style={{ height: scale(250) ,marginTop:scale(20)}}>
                        ...
                        <View style={{ marginTop: scale(90) }}>
                            <Text style={[styles.label, { fontSize: moderateScale(14), marginLeft: scale(20), marginBottom: scale(10), marginEnd: scale(10) }]}>{ingresa_un_pin_de}</Text>
                        </View>
                    </View>
                </ImageBackground>
                {/* <View style={{ justifyContent: 'center', }}>
                    ...
                    <View style={{ marginTop: 30, alignSelf: 'center' }}>
                        <Text style={{ color: '#7FB50A', fontSize: 14, fontWeight: 'bold' }}>{Resend_OTP}</Text>
                    </View>
        ...
        return (
            ...
            <View style={{flexDirection: "row"}}>
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress1} style={{backgroundColor:'#918c8c'}}>
              ...
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress2} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    2
                  </Text>
                </TouchableOpacity>
              ...
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress3} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    3
                  </Text>
                </TouchableOpacity>
            ...
            <View style={{flexDirection: "row"}}>
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress4} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    4
                  </Text>
                </TouchableOpacity>
              ...
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress5} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    5
                  </Text>
                </TouchableOpacity>
              ...
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress6} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    6
                  </Text>
                </TouchableOpacity>
            ...
            <View style={{flexDirection: "row"}}>
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress7} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    7
                  </Text>
                </TouchableOpacity>
              ...
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress8} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    8
                  </Text>
                </TouchableOpacity>
              ...
              <View style={styles.button}>
                <TouchableOpacity onPress={this.onPress9} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    9
                  </Text>
                </TouchableOpacity>
            ...
            {/* <View style={{flexDirection: "row"}}>
              ...
              <View style={[styles.button,{alignSelf:'center'}]}>
                <TouchableOpacity onPress={this.onPress0} style={{backgroundColor:'#918c8c'}}>
                  <Text style={styles.buttonLabel}>
                    0
                  </Text>
                </TouchableOpacity>
